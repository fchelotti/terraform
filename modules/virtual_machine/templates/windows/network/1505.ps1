...
route add 0.0.0.0 mask 0.0.0.0 10.192.38.129 -p
route add 10.192.38.128 mask 255.255.255.128 10.192.38.129 -p
route add 10.113.66.128 mask 255.255.255.128 10.113.66.129 -p
...
route add 10.113.70.128 mask 255.255.255.128 10.113.70.148 -p
