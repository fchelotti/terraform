...
route add 10.105.170.0 mask 255.255.255.0 10.209.160.1 -p
route add 10.105.177.0 mask 255.255.255.0 10.209.160.1 -p
route add 10.0.0.0 mask 255.0.0.0 10.209.160.100 -p
route add 10.106.255.192 mask 255.255.255.192 10.209.160.100 -p
route add 172.16.0.0 mask 255.240.0.0 10.209.160.100 -p
route add 192.168.0.0 mask 255.255.0.0 10.209.160.100 -p
route add 10.106.250.0 mask 255.255.255.0 10.106.8.1 -p
route add 10.106.251.0 mask 255.255.255.0 10.106.8.1 -p
route add 10.106.255.128 mask 255.255.255.192 10.106.8.1 -p
route add 10.119.243.0 mask 255.255.255.0 10.106.8.1 -p
route add 10.119.249.0 mask 255.255.255.0 10.106.8.1 -p
